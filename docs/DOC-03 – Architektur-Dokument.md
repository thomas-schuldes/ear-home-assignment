...
Diese Architekturbeschreibung erfüllt die Anforderungen der EAR-Entwicklungsaufgabe und umfasst
eine **statische** und eine **dynamische Sicht** auf das System.
...
- **SOAP-Adapter → EAR SOAP-Service**  
  Verantwortlich für die Übermittlung an die offizielle EAR-Schnittstelle  
  (`submitIstInput`).
...
## 2.1 Frontend sendet die Mengenmeldung über
POST /mengenmeldungen.
...
## 2.5 Der SOAP-Adapter ruft den EAR SOAP-Webservice
submitIstInput anhand der bereitgestellten WSDL auf.
...
## 2.8 Das Frontend kann über
GET /mengenmeldungen jederzeit den Status abrufen.
...
SOAP-Fehlermeldungen werden persistiert und sind einsehbar

# 4. Lastspitzenstrategie

Die Anforderungen verlangen, dass Mengenmeldungen jederzeit abgegeben werden können – auch bei erhöhtem Lastaufkommen.

Daher folgt das System diesen Prinzipien:
...
Alle Meldungen werden zuerst gespeichert.
